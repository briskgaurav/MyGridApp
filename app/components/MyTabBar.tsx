...
import { Bars2Icon, BoltIcon, ChartBarIcon, Cog6ToothIcon, HomeIcon, SunIcon } from 'react-native-heroicons/outline';
...
function MyTabBar({ state, descriptors, navigation }: BottomTabBarProps) {
  ...
  return (
    <View className="flex-row items-center justify-between gap-2 absolute bottom-5 mx-16 bg-white/10 elevation-sm rounded-full px-1 py-2">
      {state.routes.map((route, index) => {
        ...
        return (
          <TouchableOpacity
            ...
            activeOpacity={0.7} 
            style={{
              backgroundColor: isFocused ? 'rgba(255, 255, 255,0.99)' : 'rgba(255, 255, 255,0.12)',
